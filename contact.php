<?php
	...
	if (isset($_POST['email'])) {
		...
		$email_to = "info@posthype.com";
		$email_subject = "My offer for posthype.com";
...
<html lang="en">
		<head>
				<meta charset="utf-8">
				<title>Sales Inquery || posthype.com</title>
				...
				<div class="container-fluid">
					<div class="row">
							<div class="bg-faded col-sm-6 text-center col-fixed">
									<div class="vMiddle">
										<h1 class="pt-4 h2">
											<span>Thank you for offer. You will receive a response within 48 hours.</span>
										</h1>
										<div class="row d-md-flex text-center justify-content-center text-primary action-icons">
											...
											<div class="col-sm-4">
												...
												<p class="lead"><a href="mailto:info@posthype.com">info@posthype.com</a></p>
											</div>
									</div>
								</div>
							</div>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														<h1 class="pt-4 h2"><span class="text-green">posthype.com</span></h1>
